...
public class XmlWebApplicationContext extends AbstractRefreshableWebApplicationContext {
	...
	//这里是设置默认BeanDefinition的地方,在/WEB-INF/application.xml文件中,
	 ...
	 */
	//又看到了熟悉的loadBeanDefinition,就像前面对IoC容器的分析一样,这个加载过程在
	//容器refresh()时启动
	@Override
	protected void loadBeanDefinitions(DefaultListableBeanFactory beanFactory) throws BeansException, IOException {
		// Create a new XmlBeanDefinitionReader for the given BeanFactory.
		//对于XmlWebApplcationContext,当然是使用XmlBeanDefinitionReader来
		//对BeanDefinition信息进行解析
		XmlBeanDefinitionReader beanDefinitionReader = new XmlBeanDefinitionReader(beanFactory);

		// Configure the bean definition reader with this context's
		// resource loading environment.
		//这里设置ResourceLoader,因为XmlWebApplication是DefultResource的
		//子类,所以这里同样会使用DefaultResourceLoader来定位BeanDefinition
	 ...
	 */
	//这里是取得Resource位置的地方,使用了设定的默认配置位置,默认的配置
	//位置是/WEB-INFapplicationContext.xml
	@Override
